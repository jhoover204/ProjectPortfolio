...
This project was a group project in a Machine Learning course. The goal (defined below as well) was to use previously collected data on hotel bookings to build a model for predicting hotel booking cancellations. 
...
# My contribution
My role was primarily to write the code and commentary for feature engineering and the Random Forest model. We all contributed to improving feature engineering and tuning the model, but these sections are primarily mine. I was also in charge of editing the writing for the report. We all contributed to conclusions.
